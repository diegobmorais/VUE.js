<template>
    <Form @submit="cadastrarNovoUsuario" :validation-schema="validateSchema">
        <div class="container">
            ...
            <button type="submit" class="btn btn-success btn-block mb-4 me-2">Cadastre-se</button>
            <button type="button" @click="returnLogin" class="btn btn-warning btn-block mb-4">Voltar</button>
        </div>
    </Form>
</template>
