        ...
        <div class="row">
            <div class="col">
                <div class="h-100 p-5 bg-light border rounded-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Informe o nome do exercício para registro na base da
                                    dados.</small>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-outline-dark mt-2" @click="registerExercise"
...
export default {
    ...
    methods: {
        ...
        registerExercise() {
            if (this.description == '') {
                this.menssageErro = "Você deve digitar o nome do exercício para registro **"
            } else {
